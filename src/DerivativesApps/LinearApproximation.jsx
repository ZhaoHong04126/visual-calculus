...
export default function LinearApproximation() {
  return (
    <section className="subsection mt-8">
      <h2 className="section-title text-2xl font-bold mb-4 border-b-2 border-fuchsia-500 pb-2">7. 線性逼近與微分 (Linear Approximation and Differentials)</h2>
      ...
      <div className="math-box mb-6 p-6 bg-fuchsia-50 rounded-lg shadow-sm border border-fuchsia-100">
        <h3 className="text-xl font-bold mb-3 text-fuchsia-800">7.1 線性化 (Linearization)</h3>
        <p className="mb-4 text-gray-700">
      ...
      <div className="math-box mb-6 p-6 bg-blue-50 rounded-lg shadow-sm border border-blue-100 mt-8">
        <h3 className="text-xl font-bold mb-3 text-blue-800">7.2 微分 (Differentials)</h3>
        <p className="mb-4 text-gray-700">
