...
export default function ExpLogFunctions() {
  return (
    <section className="subsection mt-12">
      <h2 className="section-title text-2xl font-bold mb-4 border-b-2 border-green-500 pb-2">2. 指數與對數函數 (Exponential and Logarithmic Functions)</h2>
      ...
      <div className="math-box mb-8 p-6 bg-green-50 rounded-lg shadow-sm border border-green-200">
        <h3 className="text-xl font-bold mb-3 text-green-800">2.1 指數函數 (Exponential Functions)</h3>
      ...
      <div className="math-box mb-8 p-6 bg-cyan-50 rounded-lg shadow-sm border border-cyan-200">
        <h3 className="text-xl font-bold mb-3 text-cyan-800">2.2 對數函數 (Logarithmic Functions)</h3>
        <p className="mb-4 text-gray-800">
      ...
      <div className="math-box p-6 bg-yellow-50 rounded-lg shadow-sm border border-yellow-200">
        <h3 className="text-xl font-bold mb-3 text-yellow-800">2.3 尤拉數 <InlineMath math="e" /> 與自然對數</h3>
