...
export default function InverseHyperbolicFunctions() {
  return (
    <section className="subsection mt-12">
      <h2 className="section-title">8. 反雙曲函數 (Inverse Hyperbolic Functions)</h2>
      ...
      <div className="math-box mb-8 p-6 bg-indigo-50 rounded-lg shadow-sm border border-indigo-200">
        <h3 className="text-xl font-bold mb-4 text-indigo-800">8.1 六大反雙曲函數</h3>
      ...
      <div className="math-box mt-8">
        <h3 className="text-xl font-bold mb-3 text-indigo-800">8.2 證明：對數形式的推導</h3>
